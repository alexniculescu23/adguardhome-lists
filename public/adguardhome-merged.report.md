...
Compiled at: `2026-05-12T05:54:34.951Z`

## Output

- Latest merged file: `/home/aniculescu/adguardhome/dist/merged-latest.txt`
- Stamped merged file: `/home/aniculescu/adguardhome/dist/merged-2026-05-12T05-54-34-951Z.txt`
- Output bytes: **36,220,236**
- Output non-comment rules: **1,673,965**
- Output unique textual rules: **1,673,965**
- Output normalized domains: **1,673,548**

## Input summary before HostlistCompiler

- Sources: **8**
- Raw non-comment rules: **2,126,984**
- Sum of unique textual rules per source: **2,126,983**
- Global unique textual rules: **1,806,897**
- Duplicate textual entries across sources: **320,086** (15.05%)
- Sum of normalized domains per source: **2,125,696**
- Global unique normalized domains: **1,721,499**
- Duplicate normalized-domain entries across sources: **404,197** (19.01%)

## Per-source contribution

| Source | Raw rules | Text unique in source | Text unique only | Domains | Domain unique only | Domain unique % |
|---|---:|---:|---:|---:|---:|---:|
| OISD Blocklist Big | 405,197 | 405,197 | 166,385 | 405,197 | 136,877 | 33.78% |
| Dandelion Sprout's Anti-Malware List | 12,780 | 12,780 | 1,811 | 12,376 | 1,396 | 11.28% |
| HaGeZi Pro++ | 242,729 | 242,729 | 117,245 | 242,729 | 117,217 | 48.29% |
| HaGeZi URL Shortener | 9,882 | 9,882 | 8,565 | 9,882 | 8,547 | 86.49% |
| HaGeZi Threat Intelligence Feeds - Full | 1,292,988 | 1,292,988 | 1,068,375 | 1,292,988 | 1,060,847 | 82.05% |
| Phishing Army Extended | 145,046 | 145,046 | 145,046 | 145,046 | 60,972 | 42.04% |
